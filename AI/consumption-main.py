...
def load_current(BASEDIR_PATH) -> list:
    # -- current -- #
    PATH = BASEDIR_PATH + "private/PowerConsumption/"
...
def load_predict(BASEDIR_PATH) -> list:
    # -- predict -- #
    _, predict = predict_xgboost.run(BASEDIR_PATH)
